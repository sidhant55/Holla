...
#page{
  position:absolute;
  width:100%;/* See #right left value */
  overflow-y:auto;
} 
...
<div style="padding-top:50px"></div>
  ...
  <div class="row">
    <div class="col-sm-3" style="position:fixed">
          <h3>Your Unique Id is <b><?php echo $userRow['userCode1'];?></b></h3>
          <hr style="color:black; height:3px">
      <h3>Your Friend's Unique Id is <b><?php echo $userRow['userCode2'];?></b></h3>
      <hr style="color:black; height:3px">
        <form method="post">
    ...
    <div class="form-group">
              <div class="input-group">
                <span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
              <textarea type="text" name="name" class="form-control"  rows="7" placeholder="Deploy whats in your mind...." maxlength="1000" value="<?php echo $name ?>"></textarea>
                </div>
                <span class="text-danger"><?php echo $nameError; ?></span>
            </div>
            ...
            <h2 style="padding-left:20px; padding-top:40px; display:inline-block"><?php echo $userRow['userName'] ?></h2><h2 style="display:inline-block; padding-right:10px; float:right; padding-top:40px;"><?php echo $code2n2['userName']?></h2>
  ...
  while($row = mysql_fetch_row($results))
  {
   ...
   ?></h4>
            ...
            <div class="col-sm-2" style="border-left: thick solid #ff0000;"></div>
    </div>
    </div>
